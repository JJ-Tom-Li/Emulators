    ...
    switch(this->opcode & 0xF000)
    {
        ...
        case 0x8000:
            switch(this->opcode & 0x000F)
            {
                ...
                case 0x0004:
                    //printf("ADD V%x, V%x\n", (this->opcode & 0x0F00) >> 8, (this->opcode & 0x00F0) >> 4);
                    //printf("ADD %x, %x=", this->V[(this->opcode & 0x0F00) >> 8], this->V[(this->opcode & 0x00F0) >> 4]);
                ...
                case 0x0005:
                    //printf("SUB V%x, V%x\n", (this->opcode & 0x0F00) >> 8, (this->opcode & 0x00F0) >> 4);
                    //printf("SUB %x, %x=", this->V[(this->opcode & 0x0F00) >> 8], this->V[(this->opcode & 0x00F0) >> 4]);
                    if(this->V[x] > this->V[y]){
                        this->V[0xF] = 1; 
						this->V[x] -= this->V[y];
					}
